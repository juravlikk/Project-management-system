...
/**
 * @desc: Addition of parent task to the child task
 * @param: task - (object) task
 * @type: public
 * @topic: 1
 */
GanttTaskInfo.prototype.addParentTask = function(task)
{
    task.ChildTasks.push(this);
...
GanttTask.prototype.createConnectingLinesDS = function()
{
    ...
    //horizontal line 2
    var lineHorizontal2 = document.createElement("div");

    var posXPredecessorTask = parseInt(this.parentTask.cTaskItem[0].style.left);
    var posYPredecessorTask = parseInt(this.parentTask.cTaskItem[0].style.top);

    var posXChildTask = parseInt(this.cTaskItem[0].style.left);
    var posYChildTask = this.posY + 2;

    //width task item
    var widthChildTask = parseInt(this.parentTask.cTaskItem[0].firstChild.firstChild.width);
    var widthPredecessorTask = parseInt(this.parentTask.cTaskItem[0].firstChild.firstChild.width);
	
    if (posYPredecessorTask < posYChildTask)
    {
        if (posXChildTask > posXPredecessorTask) {
			lineHorizontal2.style.cssText = "height:1px;border-color: #4A8F43;border-style: solid;border-width: 1px 0px 0px 0px;margin: 0px; padding: 0px;z-index:0;position: absolute;" +
                "width:" + 20 + "px;left:" + (posXPredecessorTask - 20 ) + "px;top:" + (posYPredecessorTask + 5) + "px;";
			...
			lineVerticalRight.style.cssText = "border-width: 0px 0px 0px 1px; border-style: solid; border-color: #4A8F43;margin: 0px; padding: 0px;z-index:0;font-size: 1px;position: absolute;" +
                "height:" + (posYChildTask - posYPredecessorTask - 3) + "px;width:" + 1 + "px;left:" + (posXPredecessorTask - 20 ) + "px;top:" + (posYPredecessorTask + 5) + "px;";
			...
			lineHorizontal.style.cssText = "height:1px;border-color: #4A8F43;border-style: solid;border-width: 1px 0px 0px 0px;margin: 0px; padding: 0px;z-index:0;position: absolute;" +
                "width:" + (15 + (posXChildTask - posXPredecessorTask)) + "px;left:" + (posXPredecessorTask - 20 ) + "px;top:" + (posYChildTask + 2) + "px;";
			...
			lineHorizontal2.style.cssText = "height:1px;border-color: #4A8F43;border-style: solid;border-width: 1px 0px 0px 0px;margin: 0px; padding: 0px;z-index:0;position: absolute;" +
                "width:" + (posXPredecessorTask - posXChildTask + 20) + "px;left:" + (posXChildTask - 20) + "px;top:" + (posYPredecessorTask + 5) + "px;";

			lineVerticalRight.style.cssText = "border-width: 0px 0px 0px 1px; border-style: solid; border-color: #4A8F43;margin: 0px; padding: 0px;z-index:0;font-size: 1px;position: absolute;" +
                "height:" + (posYChildTask - posYPredecessorTask - 3) + "px;width:" + 1 + "px;left:" + (posXChildTask - 20) + "px;top:" + (posYPredecessorTask + 5) + "px;";

			lineHorizontal.style.cssText = "height:1px;border-color: #4A8F43;border-style: solid;border-width: 1px 0px 0px 0px;margin: 0px; padding: 0px;z-index:0;position: absolute;" +
                "width:" + (15) + "px;left:" + (posXChildTask - 20 ) + "px;top:" + (posYChildTask + 2) + "px;";
        ...
        if (posXChildTask > posXPredecessorTask) {
			...
			lineVerticalRight.style.cssText = "border-width: 0px 0px 0px 1px; border-style: solid; border-color: #4A8F43;margin: 0px; padding: 0px;z-index:0;font-size: 1px;position: absolute;" +
                "height:" + ( - posYChildTask + posYPredecessorTask - 3) + "px;width:" + 1 + "px;left:" + (posXPredecessorTask - 20 ) + "px;top:" + (posYChildTask + 5) + "px;";
			...
			lineHorizontal2.style.cssText = "height:1px;border-color: #4A8F43;border-style: solid;border-width: 1px 0px 0px 0px;margin: 0px; padding: 0px;z-index:0;position: absolute;" +
                "width:" + (posXPredecessorTask - posXChildTask + 20) + "px;left:" + (posXChildTask - 20) + "px;top:" + (posYChildTask + 5) + "px;";

			lineVerticalRight.style.cssText = "border-width: 0px 0px 0px 1px; border-style: solid; border-color: #4A8F43;margin: 0px; padding: 0px;z-index:0;font-size: 1px;position: absolute;" +
                "height:" + ( - posYChildTask + posYPredecessorTask - 3) + "px;width:" + 1 + "px;left:" + (posXChildTask - 20) + "px;top:" + (posYChildTask + 5) + "px;";
    ...
    oData.appendChild(lineHorizontal2);
...
GanttTask.prototype.create = function()
{
    ...
    if (parentTask) arrConnectingLines = this.createConnectingLinesDS();
